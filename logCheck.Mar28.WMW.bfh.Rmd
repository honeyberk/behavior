...
beanplot(Improvement ~ reorder(Group, Improvement, mean) * Behavior, bw="nrd0", data = plotframe,
         side = "b", horizontal = TRUE, col = list("yellow", "orange"), border = c("yellow2","darkorange"), main = "Improvement on Each Behavior", xlab = "Behavior", ylab = "Improvement", ylim = c(-1.5,1.5), yaxs = "i")
